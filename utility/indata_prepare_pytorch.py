...
# # clearn and build
# test_dir = '../../../data/generative_attack/mat_train'
...
# mfile_path = '../../matlab/pre_processing/cross_attack/'
# eng.addpath(eng.genpath(mfile_path), nargout=0)
# eng.preprocess_main_train(nargout=0)
...
if os.getcwd() == '/media/sambaShare/Xiaoxuan_Lu/password_watch/Code_base/Python/rnn_classifier':
    ...
    val_dir = '../../../data/generative_attack/mat_test'
...
y_train_flat, y_val_flat, y_test_flat = num2list(y_train_flat), num2list(y_val_flat), num2list(y_test_flat)
